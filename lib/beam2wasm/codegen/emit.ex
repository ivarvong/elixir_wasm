...
defmodule Beam2Wasm.Codegen.Emit do
  ...
  # NB: :bsl never reaches here — the `transition(:bsl, …)` clauses emit the :shl wop directly
  # (a dedicated nonneg/shift-amount bounds path), so it is excluded from the generic op set above.
