      ...
      Enum.any?(user, fn {_m, {:function, _, _, _, is}} ->
        Enum.any?(is, fn op ->
          match?(
            ...
            when f in [:atom_to_binary, :atom_to_list, :binary_to_existing_atom, :list_to_existing_atom],
            op
          ) or
            match?(
    ...
    [
      ...
      if(atom_names?,
        do: """
          ...
          (func $erlang.atom_to_list_1 (param $x (ref null eq)) (result (ref null eq))
            (return_call $unicode.characters_to_list_1 (call $erlang.atom_to_binary_1 (local.get $x))))
