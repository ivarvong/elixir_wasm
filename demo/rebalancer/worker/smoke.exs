...
# (mix wasm.build), stage the LIBRARY's host.mjs/imports.mjs from compiler/priv, serve on local
...
defmodule RebalancerSmoke do
  ...
  defp build do
    ...
    IO.puts("  built + staged worker assets (rebalancer.wasm #{kb} KB, host.mjs + imports.mjs from compiler/priv)")
  end
