...
This project is a BEAM→WasmGC compiler (`lib/`), a host runtime (`runtime/`), and a set of
...
"not wired in this host" stub rather than silently succeeding (see `priv/host.mjs`). No
