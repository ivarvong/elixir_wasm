...
#   scoreboard  — every public function of seventeen stdlib modules
...
defmodule Verify do
  ...
  @suites [
    {"conformance", "bench/conformance", [], ~r/TOTAL: 219\/219 cases bit-exact/, false},
    {"fuzz", "bench/fuzz", [], ~r/TOTAL: 33\/33 cases bit-exact/, false},
